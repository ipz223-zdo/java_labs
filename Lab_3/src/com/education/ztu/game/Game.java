...
public class Game {
    public static void main(String[] args) {
        ...
        // Student не є Schoolar, тому помилка компіляції
        //scollarTeam.addNewParticipant(student1);
        // Employee не є Schoolar, тому помилка компіляції
        ...
        // Допускаються тільки об'єкти типу Participant або його підкласів.
        ...
        // Employee не є Schoolar, тому матч не можливий
